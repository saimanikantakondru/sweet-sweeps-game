...
{
    public class FrostCalamityEffect : ICalamityEffect, IMovementModifierSource
    {
        private readonly FrostCalamityDataSO _data;
        ...
        public FrostCalamityEffect(
            FrostCalamityDataSO data,
        ...
        public void Apply(CalamityLevel level, float intensity)
        {
            ...
            if (!_isActive)
            {
                ...
                Debug.Log("[FrostCalamityEffect] LevelOne — movement modifiers applied.");
            }

            if (level == CalamityLevel.LevelTwo && !_hazardsSpawned)
            {
                _hazardsSpawned = true;
                _tileSpawner.SpawnOnRandomTiles(_data.SpikeCount, _data.IceSpikeOverlayPrefab, _data.MinSpacing);
                Debug.Log("[FrostCalamityEffect] LevelTwo — ice spikes spawned.");
            }
        }
        ...
        public void Remove()
        {
            ...
            Debug.Log("[FrostCalamityEffect] Removed.");
        }
    }
}